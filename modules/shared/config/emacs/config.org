...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Tapani Moilanen"
    user-mail-address "moilanen.tapani@gmail.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/tapani/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/tapani/bin" "/profile/bin" "/Users/tapani/.npm-packages/bin" "/Users/tapani/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
